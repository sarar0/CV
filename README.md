...
| :-- | :-- | :-- | :-- |
|<a href="https://github.com/sarar0/Currency-App">Currency converter</a> | This currency converter uses a third-party API to get real-time currency exchange rates.  | Work in progress | React, Express, JavaSript, HTML, CSS, Bootstrap |
...
|<a href="https://github.com/sarar0/Week-8--SpaceBook">SpaceBook</a> | Group project at Makers. A replica of Facebook: users can sign up and login, post something, see other people's posts and comment on them. | 2 weeks | Ruby on Rails, HTML, CSS, Capybara, RSpec, Travis, Heroku |
...
| <a href="https://github.com/sarar0/Week-7--News-summary-challenge">News summary challenge</a> | The app gathers headlines from the Guardian newspaper API and displays them on a page, with the relevant images. Clicking on a headline shows a summary of the article. Project completed during Makers course.| 2 days | Javascript, HTML, CSS |
| <a href="https://github.com/sarar0/Week-5--Bowling-challenge">Bowling challenge</a> | This is 10 pin bowling scorecard, with an interface displaying a table with scores for each frame. Project completed during Makers course. | 4 days | Javascript, HTML, CSS, Jasmine, jQuery |
